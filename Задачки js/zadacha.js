...
let call=[200,3423,342,43,532]
let limit=2000

function getDiet(call,limit){
  let quantity=0
  while(limit>=call[quantity]){
    limit-=call[quantity]
    quantity++
  }
  return quantity
...
let arr = ['11112012','11112014','11112012']
let ear = 2012
let quallity=0

function getDocumentsNumbers(arr,ear){
 
  for(let i=0;i<arr.length;i++){
    if(arr[i].indexOf(ear,4)!==-1){
      quallity++
  } 
